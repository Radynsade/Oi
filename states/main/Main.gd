...
onready var my_ip_address_label = $Network/IpContainer/LocalIpLabel
onready var ip_input = $Network/InputContainer/IpLineEdit
onready var port_input = $Network/InputContainer/PortLineEdit
